...
abstract Color(Int) from Int to Int {
	...
	@:op(A * B)
	public inline function multiply(f:Float):Color {
		return fromARGBf(get_af() * f, get_rf() * f, get_gf() * f, get_bf() * f);
	}

	@:op(A / B)
	public inline function divide(f:Float):Color {
		return fromARGBf(get_af() / f, get_rf() / f, get_gf() / f, get_bf() / f);
	}

	@:op(A + B)
	public inline function add(f:Color):Color {
		return fromARGBf(get_af() + f.af, get_rf() + f.rf, get_gf() + f.gf, get_bf() + f.bf);
	}
}
